...
export default function LoginPage() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.from(".form-el", { opacity: 0, y: 26, duration: 0.65, stagger: 0.09, ease: "power3.out", delay: 0.25 });
    });
    return () => ctx.revert();
  }, []);
      ...
      <AuthPanelWrapper>
        ...
        <div className="lp-el animate-float bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-5">
          ...
          <p className="text-gray-300 text-sm leading-relaxed">
            &ldquo;Made over $5,000 reselling on ResellHub. Payouts are fast and the process is
            seamless!&rdquo;
          </p>
